    ...
    <section class="container">
      ...
      <div class="container_box">
        ...
        <form action="/admin/register" method="post">
          ...
          <div class="inputArea">
            <label>상품명</label>
            <input type="text" id="gdName" name="gdName"/>
          </div>
          <div class="inputArea">
            <label>상품 가격</label>
            <input type="text" id="gdPrice" name="gdPrice"/>
          </div>
          <div class="inputArea">
            <label>재고</label>
            <input type="text" id="gdStock" name="gdStock"/>
          </div>
          <div class="inputArea">
            <label>이미지</label>
            <input type="text" id="gdImg" name="gdImg"/>
